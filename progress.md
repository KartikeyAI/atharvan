...
- Migrations `0003_operator_roles.sql`, `0004_platform_configuration_registry.sql`, `0005_platform_secret_references.sql`, and `0006_model_provider_catalogue.sql` are complete and locally validated but are not yet applied to the development database because live migration and deployment work is deferred until the remaining development slices are complete.
