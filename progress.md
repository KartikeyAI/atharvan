...
- Migration `0003_operator_roles.sql` is complete and locally validated but is not yet applied to the development database because live migration and deployment work is deferred until the remaining development slices are complete.
