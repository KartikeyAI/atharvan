...
- [ ] Inspect repository defaults, protections, and existing contents.
- [ ] Define monorepo structure and package boundaries.
- [ ] Add coding, testing, migration, and security conventions.
- [ ] Configure CI for lint, type-check, unit, integration, and migration validation.
- [ ] Define environment and secret bootstrap contract.
...
- [ ] No plaintext credentials or production secrets are stored in the repository.
...
- [ ] No fake data, placeholder metrics, or mock operational success states.
